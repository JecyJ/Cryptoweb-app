    ...
    return (
      <div className='sticky left-0 top-0 z-10 ease-in duration-300 bg-gradient-to-r from-blue-200 from-40% via-blue-300 via-60% to-blue-400 to-90%'>
        <div className='max-w-[450px] md:max-w-[1180px] sm:max-w-[650px] m-auto flex justify-between items-center py-1 px-5'>
          ...
          <div onClick={handleSession} className='space-x-5 hidden md:flex items-center'>
            {handleSession()}
          </div>
          ...
          <div className={nav ? 'fixed md:hidden left-0 top-0 right-0 bottom-0 w-[100%] h-full bg-[#3984F4] ease-in-out duration-700' : 'fixed md:hidden bottom-[-100%] h-full bg-[#3984F4] ease-in-out duration-700'}>
            ...
            <div onClick={handleNav} onAuxClick={handleSession} className='flex flex-col justify-center items-center max-w-[450px] sm:max-w-[650px] m-auto py-6 px-5 space-x-5 font-medium'>
              {handleSession()}
            </div>
          </div>   
        </div>      
